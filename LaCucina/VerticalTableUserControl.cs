...
namespace LaCucina
{
    public partial class VerticalTableUserControl : UCtable
    {
        ...
        public VerticalTableUserControl(int id, string tableNum, int chairCount, TableStatus tableStatus, bool isInEditingMode) :base(id,tableNum, chairCount, tableStatus,isInEditingMode)
        {
            InitializeComponent();
